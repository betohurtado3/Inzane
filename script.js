...
const config = {
  brushSize: 25.0, // Tamaño del "pincel" (área de influencia del mouse)
  brushStrength: 0.5, // Fuerza del pincel (qué tanto empuja el fluido)
  distortionAmount: 2.5, // Nivel de distorsión visual en el display
  fluidDecay: 0.98, // Factor de disipación del fluido
  trailLength: 0.8, // Persistencia de las estelas
  stopDecay: 0.85, // Qué tanto se desvanece el fluido al dejar de mover el mouse
  color1: "#000080", // Paleta de colores para el gradiente
  color2: "#203CC9",
  color3: "#010a2cff",
  color4: "#125572ff",
  colorIntensity: 1.0, // Intensidad general de los colores
  softness: 1.0, // Suavidad de mezcla entre colores
};
